...
public class MethodCreation01 {
   ...
   4) method name + parametreler ==> method signature
    ...
    public static void main(String[] args) {
        ...
        int dikdortgeninAlaniSonucu = dikdortgeninAlani(2, 3);
        System.out.println(dikdortgeninAlaniSonucu);


        int dikdortgeninCevresiSonucu = dikdortgeninCevresi(2, 3);
        System.out.println(dikdortgeninCevresiSonucu);
    }
